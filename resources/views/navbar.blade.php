...
<nav class="navbar navbar-expand-md">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarMenu">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ url('todolist') }}"><i class="bi bi-list-check"></i> To do List</a>
                </li>
                {{-- <li class="nav-item">
        ...
        <ul class="navbar-nav">
            <li>
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="bi bi-person-fill"></i> <span class ="user-name">[nama user]</span>
                </a>
